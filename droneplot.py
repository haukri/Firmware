...
plt.plot([x/1000000.0 - offset for x in exogenous['timestamp']], exogenous['y'], color='purple', linewidth=1.5, label='XKF Pitch')
plt.plot([x/1000000.0 - offset for x in exogenous['timestamp']], exogenous['z'], color='b', linewidth=1.5, label='observer Pitch')
